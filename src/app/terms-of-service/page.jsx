    ...
    return (
      <div className="flex flex-col w-full bg-[#efefef]">
        ...
        <div className="w-11/12 mx-auto mt-[20px]">
          ...
          <h2 className="font-bold text-xl text-[blue] mb-2">Overview</h2>
          <p className="font-normal text-base mb-3 text-[#333]">
            This website is operated by Mijn winkel. Throughout the site, the
            terms “we”, “us” and “our” refer to Mijn winkel. Mijn winkel offers
          ...
          <h2 className="font-bold text-xl text-[blue] mt-3 mb-2">
          ...
          <p className="font-normal text-base mb-3 text-[#333]">
            In no case shall Mijn winkel, our directors, officers, employees,
          ...
          <p className="font-normal text-base mb-3 text-[#333]">
            You agree to indemnify, defend and hold harmless Mijn winkel and our
          ...
          <p className="font-normal text-base mb-3 text-[#333]">
            ...
            accordance with the laws of Netherlands.
          </p>
          <h2 className="font-bold text-xl text-[blue] mt-3 mb-2">
